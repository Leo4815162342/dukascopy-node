...
function normaliseDates({ instrument, startDate, endDate, timeframe, utcOffset }) {
    ...
    const minIsoDate = timeframe === Timeframe.d1 || timeframe === Timeframe.mn1 ? minStartDateDaily : minStartDate;
...
export { BufferFetcher, Format, Instrument, Price, Timeframe, URL_ROOT, formatOutput, generateUrls, normaliseDates, processData, schema, validateConfig, validator };
